...
- crée les matchs et saisit les scores officiels (groupes « matchs personnalisés »), ou lie le groupe à une compétition officielle d'un des 9 sports couverts (football, basketball, rugby, volleyball, handball, hockey, baseball, NFL, AFL) : matchs importés depuis api-sports, scores live et points calculés automatiquement ;
